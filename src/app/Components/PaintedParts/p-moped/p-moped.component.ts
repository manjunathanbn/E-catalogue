...
@Component({
  selector: 'app-p-moped',
  templateUrl: './p-moped.component.html',
  styleUrls: ['./p-moped.component.scss']
})
export class PMopedComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // this.tabData=[{name:"TVS XL"},{name:"TVS XL-100"},{name:"SCOOTY"}];
    // this.innerTab=[{id:1,image:'1',name:"TVS"},{id:2,image:'2',name:"TVS XL"},{id:3,image:'3',name:"Scooty"},{id:4,image:'4',name:"Scooter"},{id:5,image:'5',name:"Motor Cycle"}];
  ...
  getPaintMopedDetail() {
    ...
    this.masterServices.getReq('', 'api/Catalouge/GetPaintedModelDetails?Type=moped').subscribe(
      (resp: any) => 
     {
